...
*/
export function processContext (activeContext = null, localContext = [], remoteContexts = {}, options = {}, documentIri = null) {
 ...
 */
export function expandIri (activeContext, value, {vocab = false, documentRelative = false, localContext = null, defined = null}) {
 ...
 */
export function expand (activeContext, element, activeProperty = null) {
 ...
 */
export function expandValue (activeContext, activeProperty, value) {
