module.exports = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c54 = function(rdfliteral, datatype) { return {'@type': datatype['@id']}; },
        ...
        peg$c64 = function(pname) {
            var item = {"@id": pname};
            item[PNAME_TAG] = true;
            return item;
        },
        peg$c65 = function(bnode) {
                return bnode;
            },
        peg$c66 = "<",
        ...
        peg$c72 = function(iriref) {
                return {"@id": iriref.join('')};
            },
        peg$c73 = ":",
        peg$c74 = { type: "literal", value: ":", description: "\":\"" },
        peg$c75 = function(pfx) {
                return pfx;
            },
        peg$c76 = function(ns, l) {
                return (ns === null? '' : ns + ':') + l;
            },
        peg$c77 = "_:",
        ...
        peg$c81 = function(lead, first, chars) { return chars.join(''); },
        peg$c82 = function(lead, first, rest) {
        ...
        peg$c118 = function(first, rest) { return (first || '') + rest; },
        peg$c119 = "\"\"\"",
        ...
        peg$c148 = /^[\xC0-\xD6]/,
        peg$c149 = { type: "class", value: "[\\u00C0-\\u00D6]", description: "[\\u00C0-\\u00D6]" },
        peg$c150 = /^[\xD8-\xF6]/,
        peg$c151 = { type: "class", value: "[\\u00D8-\\u00F6]", description: "[\\u00D8-\\u00F6]" },
        peg$c152 = /^[\xF8-\u02FF]/,
        peg$c153 = { type: "class", value: "[\\u00F8-\\u02FF]", description: "[\\u00F8-\\u02FF]" },
        peg$c154 = /^[\u0370-\u037D]/,
        ...
        peg$c178 = function(first, chars) { return chars.join(''); },
        peg$c179 = function(first, rest) {
                return first + (rest? rest.join('') : '');
            },
        peg$c180 = "%",
        peg$c181 = { type: "literal", value: "%", description: "\"%\"" },
        peg$c182 = function(a, b) { return '%' + a + b; },
        peg$c183 = /^[A-F]/,
